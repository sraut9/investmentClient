...
@Component({
  selector: 'app-portfolio-zerodha-summary',
  templateUrl: './portfolio-zerodha-summary.component.html',
  styleUrls: ['./portfolio-zerodha-summary.component.css']
})
export class PortfolioZerodhaSummaryComponent implements OnInit {
